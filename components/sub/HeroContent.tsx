...
>
    Akarsh R
                ...
                >
                    I&apos;m a Software Engineer with experience in Website, Software development, and Project Planning.
                </motion.p>
    ...
    variants={{
        ...
        visible: { opacity: 1, x: 0, transition: { duration: 0.4, ease: "easeInOut", delay: 0.2 } }
    }}
